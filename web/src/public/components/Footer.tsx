        ...
        <div style={styles.content}>
          <div style={styles.logoSection}>
            ...
            <div style={styles.socialIcons}>
              <a
                href="https://instagram.com/brewedat"
                target="_blank"
              ...
              <a
                href="https://facebook.com/brewedat"
                target="_blank"
                rel="noopener noreferrer"
                style={styles.socialIcon}
                aria-label="Facebook"
              ...
              <a
                href="https://tiktok.com/@brewedat"
                target="_blank"
                rel="noopener noreferrer"
                style={styles.socialIcon}
                aria-label="TikTok"
              ...
              <a
                href="https://youtube.com/@brewedat"
                target="_blank"
                rel="noopener noreferrer"
                style={styles.socialIcon}
                aria-label="YouTube"
              ...
              <a
                href="https://www.linkedin.com/company/brewedat/"
                target="_blank"
                rel="noopener noreferrer"
                style={styles.socialIcon}
                aria-label="LinkedIn"
...
const styles = {
  ...
  socialIcon: {
    ...
    height: '36px',
    borderRadius: '8px',
    backgroundColor: 'rgba(31, 53, 64, 0.08)',
    color: '#5a6672',
