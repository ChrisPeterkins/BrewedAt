...
const styles = {
  loading: { display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', fontSize: '18px', color: '#25303d' },
  ...
  episodeNumber: { fontSize: '12px', color: '#25303d', fontWeight: '600' as const, textTransform: 'uppercase' as const },
  featured: { backgroundColor: '#fd5526', color: '#FFFFFF', padding: '4px 8px', borderRadius: '4px', fontSize: '11px', fontWeight: '600' as const },
  episodeTitle: { fontSize: '24px', fontWeight: '600' as const, color: '#1f3540', marginBottom: '8px' },
  guest: { fontSize: '14px', color: '#fd5526', marginBottom: '12px', fontStyle: 'italic' as const },
  ...
  link: { padding: '8px 16px', backgroundColor: '#fd5526', color: '#FFFFFF', borderRadius: '6px', fontSize: '14px', fontWeight: '600' as const, textDecoration: 'none' },
  noEpisodes: { textAlign: 'center' as const, padding: '60px 24px', color: '#25303d' },
};
