...
export default function SubmitEventPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitted(true);
      setFormData({ name: '', description: '', eventDate: '', eventTime: '', location: '', address: '', organizerName: '', organizerEmail: '', organizerPhone: '', websiteUrl: '' });
    } catch (error) {
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} style={styles.form}>
                ...
                <div style={styles.field}>
                  ...
                  <textarea name="description" value={formData.description} onChange={handleChange} required rows={4} style={styles.textarea} />
                </div>
                ...
                <div style={styles.row}>
                  <div style={styles.field}>
                    ...
                    <input type="text" name="organizerName" value={formData.organizerName} onChange={handleChange} required style={styles.input} />
                  </div>
                  <div style={styles.field}>
                    <label style={styles.label}>Email *</label>
                    <input type="email" name="organizerEmail" value={formData.organizerEmail} onChange={handleChange} required style={styles.input} />
                  </div>
                </div>
                ...
                <div style={styles.row}>
                  <div style={styles.field}>
                    ...
                    <input type="tel" name="organizerPhone" value={formData.organizerPhone} onChange={handleChange} style={styles.input} />
                  </div>
                  <div style={styles.field}>
...
const styles = {
  ...
  submitButton: { padding: '14px 32px', backgroundColor: '#D4922A', color: '#FFFFFF', border: 'none', borderRadius: '8px', fontSize: '16px', fontWeight: '600' as const, cursor: 'pointer' },
